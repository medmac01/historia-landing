      ...
      <div className="py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              <div className="mb-2">
                ...
                <Link href="/" className="inline-block" aria-label="Cruip">
                  ...
                  <img src='/images/historia-h.png' className='h-16'></img>
                </Link>
              </div>
              <div className="text-gray-400">Histouria is your trusted travel partner, bringing the past to life as you explore the world's wonders. Unlock history, discover culture, and make your journeys unforgettable with us. Join the adventure today!</div>
            </div>
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                ...
                <ul>
                  <li className="mb-1">
                    <Link href="/" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Locations</Link>
                  </li>
                  <li className="mb-1">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; Histouria 2023. All rights reserved.</div>
